                ...
                <div class="mb-1">
                    <button
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="ml-3 transition-opacity duration-300 sidebar-text">Travel Vlogs</span>
                        </div>
                        <svg class="w-4 h-4 transition-transform duration-300 dropdown-arrow" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                    ...
                    <div class="pl-4 ml-4 border-l dropdown-menu hidden">
                        <a href="{{ route('admin.t_vlogs.index') }}"
                            class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-700 rounded-lg mt-1 {{ request()->routeIs('admin.t_vlogs.index') ? 'bg-blue-50 text-blue-700' : '' }}">
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    fill="currentColor" class="bi bi-list-ul" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd"
                                ...
                                <span class="transition-opacity duration-300 sidebar-text ml-3">Travel Vlog List</span>
                            </div>
                        </a>
                        <a href="{{ route('admin.t_vlogs.create') }}"
                            class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-700 rounded-lg {{ request()->routeIs('admin.t_vlogs.create') ? 'bg-blue-50 text-blue-700' : '' }}">
                            <div class="flex items-center"> <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                    height="16" fill="currentColor" class="bi bi-plus-square"
                                    viewBox="0 0 16 16">
                                    <path
                ...
                <div class="mb-1">
                    <button
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="ml-3 transition-opacity duration-300 sidebar-text">Blogs</span>
                        </div>
                        <svg class="w-4 h-4 transition-transform duration-300 dropdown-arrow" fill="none"
                            stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                    ...
                    <div class="pl-4 ml-4 border-l dropdown-menu hidden">
                        <a href="{{ route('admin.articles.index') }}"
                            ...
                            <div class="flex items-center">
                                ...
                                <span class="transition-opacity duration-300 sidebar-text ml-3">Blog List</span>
                            </div>
                        </a>
                        <a href="{{ route('admin.articles.create') }}"
                            ...
                            <div class="flex items-center"> <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                    ...
                                    <path
                                        d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4" />
                                </svg><span class="transition-opacity duration-300 sidebar-text ml-3">Add Blog</span>
                            </div>
                        </a>
                    </div>
                </div>
