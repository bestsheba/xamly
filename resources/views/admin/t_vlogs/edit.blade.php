...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold text-gray-900">Edit Travel Vlog</h1>
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            <form action="{{ route('admin.t_vlogs.update', $tVlog) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-4">
                    ...
                    <input type="url" 
                           id="youtube_url" 
                           name="youtube_url" 
                           value="{{ old('youtube_url', $tVlog->youtube_url) }}"
